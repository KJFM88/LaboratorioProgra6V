...
namespace WBL
{
    ...
    public class ProveedorService : IProveedorService
    {
        ...
        public async Task<DBEntity> CREATE(ProveedorEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("dbo.ProveedorInsertar", new { entity.Identificacion, entity.nombre, entity.PrimerApellido, entity.SegundoApellido, entity.Edad, entity.FechaNacimiento });
                return await result;
            }
            catch (Exception)
            {
        ...
        public async Task<DBEntity> UPDATE(ProveedorEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("dbo.ProveedorActualizar ", new { entity.IdProveedor, entity.Identificacion, entity.nombre, entity.PrimerApellido, entity.SegundoApellido, entity.Edad, entity.FechaNacimiento });
                return await result;
            }
            catch (Exception)
            {
        ...
        public async Task<DBEntity> DELETE(ProveedorEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("dbo.ProveedorActualizar ", new { entity.IdProveedor });
                return await result;
            }
            catch (Exception)
            {
